$(function () {
    ...
    var config = {
        apiKey: "AIzaSyBcSDux1G98oK3WT8TBodKestyYa8y1sX0",
        authDomain: "rps-multiplayer-c1350.firebaseapp.com",
        databaseURL: "https://rps-multiplayer-c1350.firebaseio.com",
        projectId: "rps-multiplayer-c1350",
        storageBucket: "",
        messagingSenderId: "785747898071"
    };
        ...
        if (playerNum) {
            ...
            if (currentTurn === 1) {
                ...
                if (currentTurn === playerNum) {
                    ...
                    $("#player" + playerNum + " ul").append("<li><button>Rock</button></li><li><button>Paper</button></li><li><button>Scissors</button></li>");
                }
                else {
